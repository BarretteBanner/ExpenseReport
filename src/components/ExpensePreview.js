...
export default class ExpensePreview extends React.Component{
    approvePressed = () => {
        fetch(`http://localhost:3000/approve-${this.props.expense.id}`)
        this.props.refresh()
    }


    rejectPressed = () => {
        fetch(`http://localhost:3000/reject-${this.props.expense.id}`)
        this.props.refresh()
    }
    render(){
        return(
            <View style={styles.component}>
                ...
                <View style={styles.view3}>
                    <TouchableOpacity style={styles.approve} onPress={() => this.approvePressed()}>
                        <View>
                            <Text style={styles.button}>Approve</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.reject} onPress={() => this.rejectPressed()}>
                        <View>
